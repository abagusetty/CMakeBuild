...
function(find_or_build_dependency __name __was_found)
    if(TARGET ${__name}_External)
        get_property(__label TARGET ${__name}_External PROPERTY INTERFACE_SOURCES)
        ...
        if(${__was_found})
            ...
            set_property(TARGET ${__name}_External PROPERTY INTERFACE_SOURCES "found_dependency")
        else()
