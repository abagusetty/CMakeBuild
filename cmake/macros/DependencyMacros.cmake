...
function(find_or_build_dependency __name __was_found)
    if(TARGET ${__name}_External)
        get_property(__label TARGET ${__name}_External PROPERTY LABELS)
        if (${__label} STREQUAL "found_dependency")
        ...
        if(${__was_found})
            add_custom_target(${__name}_External)
            set_property(TARGET ${__name}_External PROPERTY LABELS "found_dependency")
        else()
