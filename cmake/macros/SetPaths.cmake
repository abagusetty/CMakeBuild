...
macro(set_paths)
    ...
    get_filename_component(CMSB_CMAKE ${CMSB_MACROS} DIRECTORY)

    #The root of the CMakeBuild install
    get_filename_component(CMSB_ROOT ${CMSB_CMAKE} DIRECTORY)

    #The location of our find scripts
    set(CMSB_FIND_SCRIPTS ${CMSB_CMAKE}/find_external)

    #The location of our build scripts
    set(CMSB_BUILD_SCRIPTS ${CMSB_CMAKE}/build_external)
