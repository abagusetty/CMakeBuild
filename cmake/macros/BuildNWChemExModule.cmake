...
function(build_nwchemex_module SUPER_PROJECT_ROOT)
    ...
    set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -Wall ${NWX_GCC_TOOLCHAIN_FLAG}")
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -O3 -Wall ${NWX_GCC_TOOLCHAIN_FLAG}")
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -O3 -Wall ${NWX_GCC_TOOLCHAIN_FLAG}")
