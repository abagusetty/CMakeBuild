...
elseif(NOT "${FINDLAPACKE_essl_found}" STREQUAL "-1")
    ...
    list(APPEND LAPACKE_DEFINITIONS "-DTAMM_LAPACK_COMPLEX8=lapack_complex_float")
    list(APPEND LAPACKE_DEFINITIONS "-DTAMM_LAPACK_COMPLEX16=lapack_complex_double")      
else()
    list(APPEND LAPACKE_DEFINITIONS "-DTAMM_LAPACK_INT=lapack_int")
    list(APPEND LAPACKE_DEFINITIONS "-DTAMM_LAPACK_COMPLEX8=lapack_complex_float")
    list(APPEND LAPACKE_DEFINITIONS "-DTAMM_LAPACK_COMPLEX16=lapack_complex_double")    
