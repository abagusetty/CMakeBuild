...
if(NOT "${FINDCBLAS_substring_found}" STREQUAL "-1")
    ...
    string(FIND "${CBLAS_LIBRARIES}" "ilp64" _mkl_ilp64_found)
    if(_mkl_ilp64_found)
...
elseif(NOT "${FINDCBLAS_essl_found}" STREQUAL "-1")
    ...
    string(FIND "${CBLAS_LIBRARIES}" "essl6464" _essl_ilp64_found)
    string(FIND "${CBLAS_LIBRARIES}" "esslsmp6464" _esslsmp_ilp64_found)
    if(_essl_ilp64_found OR _esslsmp_ilp64_found)
        set(BLAS_INT4 OFF CACHE BOOL "BLAS INT SIZE" FORCE)
    endif()    
