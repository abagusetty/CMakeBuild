...
if(LINK_STATIC_GPU_LIBS AND ${CMSB_PROJECTS}_HAS_CUDA)
  set(LIBRETT_LINK_STATIC_GPU_LIBS "-DLIBRETT_LINK_STATIC_GPU_LIBS=ON")
endif()
...
ExternalProject_Add(Librett_External
    ...
    -DENABLE_CUDA=${${CMSB_PROJECTS}_HAS_CUDA} -DENABLE_HIP=${${CMSB_PROJECTS}_HAS_HIP} 
    -DCMAKE_CUDA_ARCHITECTURES=${GPU_ARCH} ${LIBRETT_LINK_STATIC_GPU_LIBS}
