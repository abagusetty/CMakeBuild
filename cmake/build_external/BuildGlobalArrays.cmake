...
enable_language(Fortran)
    ...
    if(ENABLE_LOCAL_BUILD)
      set(ENABLE_GA_LOCAL_BUILD "-DENABLE_LOCAL_BUILD=ON -DLOCAL_BUILD_PATH=${LOCAL_BUILD_PATH}")
    endif()
    ...
    ExternalProject_Add(GlobalArrays_External
        ...
        ${GA_CMSB_EXTRA_LIBS} ${Clang_GCCROOT} ${ENABLE_CUDA} ${ENABLE_HIP} ${USE_CRAYSHASTA} ${ENABLE_GA_LOCAL_BUILD}
    ...
    ExternalProject_Add(GlobalArrays_External
        ...
        ${GA_DPCPP} -DGA_RUNTIME=${GA_RUNTIME} -DENABLE_SYSV=${GA_ENABLE_SYSV} -DENABLE_PROFILING=${USE_GA_PROFILER} 
        ${GA_LINALG_THREAD_LAYER} -DLINALG_REQUIRED_COMPONENTS=${LINALG_REQUIRED_COMPONENTS} ${GA_ScaLAPACK} ${GA_DEV_MODE} 
        ${GA_CMSB_EXTRA_LIBS} ${Clang_GCCROOT} ${ENABLE_CUDA} ${ENABLE_HIP} ${USE_CRAYSHASTA}
        INSTALL_COMMAND ${CMAKE_MAKE_PROGRAM} install DESTDIR=${STAGE_DIR}
        CMAKE_CACHE_ARGS ${CORE_CMAKE_LISTS}
                        ${CORE_CMAKE_STRINGS}
    )
